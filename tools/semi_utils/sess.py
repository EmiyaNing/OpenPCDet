...
def sess(teacher_model, student_model,
    ...
    consistency_loss = ld_center_loss  * cfgs.CENTER_WEIGHT + ld_size_loss * cfgs.SIZE_WEIGHT + ld_cls_loss * cfgs.CLASS_WEIGHT
    consistency_weight = cfgs.CONSISTENCY_WEIGHT * sigmoid_rampup(epoch_id, cfgs.EMA_EPOCH[0], cfgs.EMA_EPOCH[1])
