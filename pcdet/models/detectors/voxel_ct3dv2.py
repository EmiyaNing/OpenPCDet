...
class Voxel_CT3DV2(Detector3DTemplate):
    ...
    def get_main_roihead_self_distillation_loss(self):
        ...
        stage_two_cls = F.softmax(self.forward_ret_dict['main_stage_two_cls'] / self.tempture)
        ...
        '''print("Now the stage_two_cls.shape = ", stage_two_cls.shape)
        ...
        cls_loss = self.distill_cost_function(matched_student_cls_preds.log(), stage_two_cls)
