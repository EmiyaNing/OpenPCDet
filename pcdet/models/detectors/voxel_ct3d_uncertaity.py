...
class Voxel_CT3D_Uncertainty(Detector3DTemplate):
    ...
    def get_training_loss(self):
        ...
        if not self.model_cfg.SELFKD:
            ...
            loss = loss + loss_rpn + loss_rcnn / (2 * self.sigma[0] ** 2) + loss_subrcnn / (2 * self.sigma[1] ** 2) \
                   + loss_main_kd * self.model_cfg.SELFWEIGHT + loss_sub_kd * self.model_cfg.SELFWEIGHT \
