...
class SESSD(Detector3DTemplate):
    ...
    def forward(self, batch_dict):
        ...
        if self.training:
            if not batch_dict['is_ema']:
                ...
                ema_dicts['ema_box_iou'] = batch_dict['batch_box_ious']
                ema_dicts['ema_dir_cls_preds'] = batch_dict['batch_dir_preds']
                return ema_dicts
        else:
    ...
    def post_processing(self, batch_dict):
        ...
        for index in range(batch_size):
            ...
            iou_preds = batch_dict['batch_box_ious'][index]
            ...
            #iou_scores    = (iou_preds.squeeze() + 1) * 0.5
            #nms_scores    = cls_scores * torch.pow(iou_scores, 4)
